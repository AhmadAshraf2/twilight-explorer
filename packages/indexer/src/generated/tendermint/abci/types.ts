  ...
  fromJSON(object: any): RequestInitChain {
    return {
      ...
      validators: globalThis.Array.isArray(object?.validators)
        ...
        : [],
      appStateBytes: isSet(object.appStateBytes) ? Buffer.from(bytesFromBase64(object.appStateBytes)) : Buffer.alloc(0),
...
function createBaseRequestQuery(): RequestQuery {
  return { data: Buffer.alloc(0), path: "", height: "0", prove: false };
}
...
function createBaseRequestBeginBlock(): RequestBeginBlock {
  return { hash: Buffer.alloc(0), header: undefined, lastCommitInfo: undefined, byzantineValidators: [] };
}
...
function createBaseResponseInfo(): ResponseInfo {
  return { data: "", version: "", appVersion: "0", lastBlockHeight: "0", lastBlockAppHash: Buffer.alloc(0) };
}
...
function createBaseResponseCheckTx(): ResponseCheckTx {
  return { code: 0, data: Buffer.alloc(0), log: "", info: "", gasWanted: "0", gasUsed: "0", events: [], codespace: "" };
}
...
function createBaseResponseCommit(): ResponseCommit {
  return { data: Buffer.alloc(0), retainHeight: "0" };
}
...
function createBaseEventAttribute(): EventAttribute {
  return { key: Buffer.alloc(0), value: Buffer.alloc(0), index: false };
}
...
function createBaseTxResult(): TxResult {
  return { height: "0", index: 0, tx: Buffer.alloc(0), result: undefined };
}
...
function createBaseValidator(): Validator {
  return { address: Buffer.alloc(0), power: "0" };
}
...
function createBaseSnapshot(): Snapshot {
  return { height: "0", format: 0, chunks: 0, hash: Buffer.alloc(0), metadata: Buffer.alloc(0) };
}
...
export type ABCIApplicationService = typeof ABCIApplicationService;
export const ABCIApplicationService = {
  ...
  listSnapshots: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestListSnapshots) => Buffer.from(RequestListSnapshots.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestListSnapshots.decode(value),
    responseSerialize: (value: ResponseListSnapshots) => Buffer.from(ResponseListSnapshots.encode(value).finish()),
  ...
  offerSnapshot: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestOfferSnapshot) => Buffer.from(RequestOfferSnapshot.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestOfferSnapshot.decode(value),
    responseSerialize: (value: ResponseOfferSnapshot) => Buffer.from(ResponseOfferSnapshot.encode(value).finish()),
  ...
  loadSnapshotChunk: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestLoadSnapshotChunk) => Buffer.from(RequestLoadSnapshotChunk.encode(value).finish()),
...
export const ABCIApplicationClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): ABCIApplicationClient;
  service: typeof ABCIApplicationService;
  serviceName: string;
};
