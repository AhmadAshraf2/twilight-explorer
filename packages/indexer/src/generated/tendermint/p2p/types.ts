...
export const DefaultNodeInfo = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.channels = reader.bytes() as Buffer;
          continue;
        case 7:
          if (tag !== 58) {
            break;
  ...
  fromJSON(object: any): DefaultNodeInfo {
    return {
      ...
      channels: isSet(object.channels) ? Buffer.from(bytesFromBase64(object.channels)) : Buffer.alloc(0),
  ...
  fromPartial<I extends Exact<DeepPartial<DefaultNodeInfo>, I>>(object: I): DefaultNodeInfo {
    ...
    message.channels = object.channels ?? Buffer.alloc(0);
